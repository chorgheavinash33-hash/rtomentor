...
// import "./question.css"; // Assuming you want to reuse your CSS
...
function QuestionBank() {
  return (
    <div className="container mt-30">
      <h1>📚 Question Bank</h1>
      <p>
        Here is a list of commonly asked RTO learning license questions with
        multiple choices and correct answers:
      </p>
